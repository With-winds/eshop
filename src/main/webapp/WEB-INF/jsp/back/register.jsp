  ...
  <div class="container">
    <div class="row">
      <div class="col-md-offset-3 col-md-5 myForm">
         <form class="form-horizontal" action="<%= basePath %>back/register" method="post" id="registerBackForm">
           <span class="heading">管理员注册</span>
           <!-- 账号 -->
           ...
           <div class="form-group" style="margin-bottom: 0">
           		<a class="pull-right" href="<%= basePath %>back/toLogin">已有账号？去登录</a>
           </div>
         </form>
      </div>
    </div>
...
//表单验证
$('#registerBackForm').bootstrapValidator({
	...
	fields: {                               //验证域
		...
		username: {                         //键名username和input的name属性值对应
			...
			validators: {
				...
				remote: {
					url: '<%= basePath %>back/checkUserNotExist.ajax',          //验证地址
					message: '用户已存在',      //提示消息
